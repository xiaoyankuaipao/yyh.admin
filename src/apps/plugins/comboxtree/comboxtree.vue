<!-- 
 *  下拉树组件
 *  @remark 来源于https://github.com/wilsonIs/vue-treeSelect
-->
<template>
    ...
    export default {
        ...
        watch:{
            ...
            treeData(val){
                if(val){
                    this.treeNodes = {
                        [this.treeProps.children]: this.$objArrDeepCopy(val,{visible:true}),
                        visible:true
                    };
                    if(this.isDefault){
                        this.setDefaultValue();
        ...
        data() {
            return {
                treeNodes:{
                    [this.treeProps.children] : this.$objArrDeepCopy(this.treeData,{visible:true}),
                    visible:true
                },
